...
# ===================== YAYIN AYARLARI =====================
VIDEO_URL = "https://cdn.codenet.work/streamgo/stremgo123/4867.m3u8"
...
command = [
    ...
    '[1:v]scale=250:80[logo];'  # 120'den 200'e çıkarıldı
    '[v0][logo]overlay=W-w-8:3[v1];'  # Logo SAĞ ÜST
